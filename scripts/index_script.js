...
//   //   const loopDistance = originalCount * itemWidth;
//   //   const offsetFromMiddle = scrollOffset - middleStartOffset;
//   //   const resetThreshold = loopDistance * (cloneFactor + 6);
...
//   // Responsive size adjustment on resize
//   //   window.addEventListener("resize", () => {
//   //     style = getComputedStyle(track);
//   //     itemGap = parseFloat(style.columnGap || style.gap || "0");
//   //     const newItemWidth = originalItems[0].getBoundingClientRect().width + itemGap;
//   //     const loopDistance = originalCount * newItemWidth;
//   //     const newMiddleOffset = cloneFactor * originalCount * newItemWidth;
